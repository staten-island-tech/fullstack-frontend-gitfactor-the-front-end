    ...
    <div class="game-and-inventory">
      <main class="game-contents">
        <div class="audio-container">
          <audio
            id="audio-bgm"
            :src="require(`@/assets/audio/bgm/${currentOST}.mp3`)"
          ></audio>
          <audio
            id="walk-sfx"
            :src="require(`@/assets/audio/sfx/walkstep.mp3`)"
          ></audio>
        </div>
          ...
          >
            ...
            <div :class="{ AC: mainAnt }" v-if="txtbx" class="textbox">
              ...
              <p class="textbox-title">
                {{
                  this.$store.state.userData.currentItem.dialogue[
                    this.textCount
                  ].name
                }}
              </p>
              <p class="textbox-test typing-class">
                {{
                  this.$store.state.userData.currentItem.dialogue[
                    this.textCount
                  ].text
  ...
  methods: {
    ...
    onEnter() {
      if (this.$store.state.userData.currentItem) {
        ...
        if (this.$store.state.userData.currentItem.itemType === "object") {
          ...
          this.puzzleQuestionCompleted =
            this.$store.state.userData.currentItem.puzzleCompleted;
    ...
    txtbxShow() {
      ...
      if (
        ...
        this.npcDialogueSprite =
        this.$store.state.userData.currentItem.dialogueSprite;
